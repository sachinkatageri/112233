...
class NuvedaHome extends StatefulWidget {
  ...
  @override
  _NuvedaHome createState() => _NuvedaHome();
}

class _NuvedaHome extends State<NuvedaHome> {
  _NuvedaHome();
      ...
      child: Stack(children: [
        ...
        Positioned(
          ...
          child: Container(
              ...
              width: MediaQuery.of(context).size.width * 0.973,
              height: 137.000,
              decoration: BoxDecoration(),
              child: Stack(children: [
                Positioned(
        ...
        Positioned(
          ...
          child: Container(
              ...
              height: MediaQuery.of(context).size.height * 0.023,
              child: AutoSizeText(
                'Welcome, you are logged in as participant.',
                style: TextStyle(
                  fontFamily: 'Lato',
                  fontSize: 16,
                  fontWeight: FontWeight.w700,
        ...
        Positioned(
          ...
          child: Container(
              ...
              height: MediaQuery.of(context).size.height * 0.034,
              child: AutoSizeText(
                'Congratulations, you have reached highest level Badge,Keep adding more points!',
                style: TextStyle(
                  fontFamily: 'Lato',
                  fontSize: 12,
                  fontWeight: FontWeight.w400,
        ...
        Positioned(
          ...
          child: Container(
              ...
              height: MediaQuery.of(context).size.height * 0.037,
              child: AutoSizeText(
                'Course Unlock your Premium courses',
                style: TextStyle(
                  fontFamily: 'Lato',
                  fontSize: 16,
                  fontWeight: FontWeight.w700,
        ...
        Positioned(
          right: 449.0,
          width: 44.0,
          top: MediaQuery.of(context).size.height * 1.004,
          height: MediaQuery.of(context).size.height * 0.017,
          child: Container(
              width: 44.000,
              height: MediaQuery.of(context).size.height * 0.017,
